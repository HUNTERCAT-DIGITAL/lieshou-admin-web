...
function listMembers(customerId, level, status, keyword) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (level)
                params.push("level=".concat(level));
            if (status)
            ...
            return [2 /*return*/, api_1.api.get("/members".concat(qs))];
        });
    });
}
...
function countMembers() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api_1.api.get('/members/count')];
        });
    });
}
/** GET /api/members/{id} */
function getMember(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api_1.api.get("/members/".concat(id))];
        });
    });
}
...
function createMember(body) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api_1.api.post('/members', body)];
        });
    });
}
/** PUT /api/members/{id} */
function updateMember(id, body) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api_1.api.put("/members/".concat(id), body)];
        });
    });
}
...
function deleteMember(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api_1.api.delete("/members/".concat(id))];
        });
    });
}
