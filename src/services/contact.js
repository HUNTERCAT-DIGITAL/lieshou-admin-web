...
function listContacts(customerId, keyword) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, api_1.api.get("/contacts".concat(qs))];
        });
    });
}
...
function countContacts() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api_1.api.get('/contacts/count')];
        });
    });
}
/** GET /api/contacts/{id} */
function getContact(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api_1.api.get("/contacts/".concat(id))];
        });
    });
}
...
function createContact(body) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api_1.api.post('/contacts', body)];
        });
    });
}
/** PUT /api/contacts/{id} */
function updateContact(id, body) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api_1.api.put("/contacts/".concat(id), body)];
        });
    });
}
...
function deleteContact(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, api_1.api.delete("/contacts/".concat(id))];
        });
    });
}
