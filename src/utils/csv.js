...
exports.PRODUCT_TEMPLATE = exports.LEAD_TEMPLATE = exports.CUSTOMER_TEMPLATE = void 0;
exports.downloadCsvTemplate = downloadCsvTemplate;
/** 下载 CSV 模板（浏览器 Blob） */
function downloadCsvTemplate(filename, header, sampleRows) {
    var esc = function (v) { return (/[",\n]/.test(v) ? "\"".concat(v.replace(/"/g, '""'), "\"") : v); };
    var lines = [header.map(esc).join(',')];
    for (var _i = 0, sampleRows_1 = sampleRows; _i < sampleRows_1.length; _i++) {
        var row = sampleRows_1[_i];
