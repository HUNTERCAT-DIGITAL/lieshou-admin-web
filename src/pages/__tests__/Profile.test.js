...
(0, vitest_1.describe)('Profile 页', function () {
    (0, vitest_1.it)('挂载时调用 fetchMe 渲染当前用户信息', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    (0, react_1.render)(<Profile_1.default />, { wrapper: wrap });
                    return [4 /*yield*/, (0, react_1.waitFor)(function () {
                            // 期望 (username) 文本在 h4 里
                            (0, vitest_1.expect)(react_1.screen.getByRole('heading', { level: 4, name: 'futurewl' })).toBeInTheDocument();
                        })];
                case 1:
                    _a.sent();
                    (0, vitest_1.expect)(react_1.screen.getByText(/租户：jxlkas/)).toBeInTheDocument();
                    (0, vitest_1.expect)(react_1.screen.getByText('42')).toBeInTheDocument();
                    // RoleTag 中文化（2026-08-25）：PLATFORM_ADMIN → 平台管理员
                    (0, vitest_1.expect)(react_1.screen.getByText('平台管理员')).toBeInTheDocument();
                    (0, vitest_1.expect)(react_1.screen.getByText('普通用户')).toBeInTheDocument();
                    (0, vitest_1.expect)(authApi.fetchCurrentUser).toHaveBeenCalled();
                    return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)('user 为 null 时显示 (unknown) + —', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    vitest_1.vi.mocked(authApi.fetchCurrentUser).mockResolvedValue({
                    ...
                    (0, react_1.render)(<Profile_1.default />, { wrapper: wrap });
                    return [4 /*yield*/, (0, react_1.waitFor)(function () {
                            (0, vitest_1.expect)(react_1.screen.getByText('(unknown)')).toBeInTheDocument();
                        })];
                case 1:
                    _a.sent();
